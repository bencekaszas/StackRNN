...
def generate_rev_trace(batch_size, seq_length=SEQ_LENGTH):
    ...
    for i in range(batch_size):
        ...
        output = np.concatenate([copied_bits, [VOCAB_EOS]])
        ...
        # The loss for predicting the first copied bit starts at index L,
...
def generate_rev_trace_old(batch_size, seq_length=SEQ_LENGTH):
    ...
    for i in range(batch_size):
        ...
        # DELAYED BY 1!!
        copied_bits = bits
        target_buf[i, pop_start+1 : pop_end+1] = copied_bits 
