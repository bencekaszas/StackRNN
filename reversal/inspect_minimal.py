...
if __name__ == "__main__":
    ...
    plot_weight_matrices(theo_params, f"Theoretical Construction (omega={OMEGA})", "theoretical_weights.png")
    ...
    plot_weight_matrices(learned_params, "SGD Learned Solution", "learned_weights.png")
